        ...
        <div class="notice-content">
          ...
          <div class="notice-details">
            ...
            <p class="liability-notice">
              <strong>LIMITATION OF LIABILITY AND DISCLAIMER:</strong> By using this service, you expressly acknowledge and agree that: (a) Muuvment Ltd., its directors, officers, employees, agents, and affiliates shall not be held liable for any direct, indirect, incidental, consequential, special, or exemplary damages arising from or related to your use of or reliance on this assessment tool, including but not limited to damages for loss of profits, goodwill, data, or other intangible losses; (b) this tool provides informational analysis only and does not constitute legal, professional, or compliance advice; (c) you are solely responsible for verifying all information and making your own compliance decisions; and (d) no warranty, express or implied, is made regarding the accuracy, completeness, or fitness for any particular purpose of the assessments provided.
            </p>
            <p class="jurisdiction">
              <strong>GOVERNING LAW AND EXCLUSIVE JURISDICTION:</strong> By using this service, you irrevocably agree to attorn to the exclusive jurisdiction of the courts of the Province of Ontario, Canada, and the federal courts of Canada located therein. This agreement, your use of the service, and any disputes arising therefrom shall be governed by and construed in accordance with the laws of the Province of Ontario and the federal laws of Canada applicable therein, without regard to conflict of law principles. You waive any objection to venue in such courts and agree that service of process may be made by any means permitted by applicable law.
            </p>
          </div>
        </div>
      </div>
